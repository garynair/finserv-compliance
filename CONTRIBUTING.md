...
Thank you for considering a contribution. This list covers **US financial-services compliance**: banking safeguards (GLBA/FFIEC), state cybersecurity regulation (NYDFS 500), securities and broker-dealer rules (SEC/FINRA), AML/BSA and sanctions, model risk management (SR 11-7 / SR 26-2), the prudential regulators, Dodd-Frank/Volcker, and the Community Reinvestment Act.

## What belongs here

- Official regulations, rules, supervisory guidance, and their supporting documents.
- Implementation guidance: risk-assessment methodologies, examination manuals, control-mapping resources, audit protocols.
- Commercial GRC and RegTech platforms with a mature, named feature set for financial services.
- Certification and training paths specific to financial-services compliance, AML, or sanctions practice.
- Government and standards bodies that own or maintain the frameworks above.

## What does not belong here

- Generic financial-services or fintech content with no compliance or regulatory angle.
- Frameworks outside this list's current scope. PCI-DSS, NIST CSF, and ISO/IEC 27001 are covered by the [Security Frameworks](https://github.com/garynair/security-frameworks) companion list; COBIT, COSO, and SOX/ITGC/ITAC by the [IT Audit & Controls](https://github.com/garynair/it-audit-controls) companion list. If in doubt, check those lists before submitting here.
